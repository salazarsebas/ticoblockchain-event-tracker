...
export default function DevTimeBanner({ simulated }: DevTimeBannerProps) {
  ...
  return (
    <div
      role="status"
      className="fixed z-50 bg-secondary text-on-secondary px-4 py-3 shadow-lg border-2 border-on-secondary/20 flex items-center gap-3 label-meta text-[11px] font-bold"
      style={{
