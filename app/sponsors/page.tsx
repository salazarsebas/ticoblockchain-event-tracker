  ...
  return (
    <main id="main" className="pb-20">
      <section className="px-6 md:px-12 bg-white py-24">
        <h1 className="text-6xl md:text-8xl font-headline font-black uppercase tracking-tighter text-primary mb-20 animate-reveal-up">
          SPONSORS
        </h1>

        {/* Tier 01: Diamante */}
        <div className="mb-24 flex flex-col md:flex-row border-t-4 border-primary pt-8 animate-fade-up stagger-1">
          <div className="md:w-1/4 mb-8 md:mb-0">
            <div className="text-8xl md:text-9xl font-headline font-black text-primary leading-none">
              01
            </div>
          ...
          <div className="md:w-3/4 flex flex-wrap gap-4">
            <div className="w-full md:flex-1 h-64 bg-primary flex items-center justify-center p-12 group transition-all duration-300">
              <Image
        ...
        {/* Tier 02: Oro */}
        <div className="mb-24 flex flex-col md:flex-row border-t-2 border-outline-variant pt-8 animate-fade-up stagger-3">
          <div className="md:w-1/4 mb-8 md:mb-0">
            <div className="text-7xl md:text-8xl font-headline font-black text-primary/40 leading-none">
              02
            </div>
          ...
          <div className="md:w-3/4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="h-40 border-2 border-primary flex items-center justify-center p-8 bg-surface-container-low grayscale hover:grayscale-0 transition-all">
              <Image
        ...
        {/* Tier 03: Plata */}
        <div className="flex flex-col md:flex-row border-t-2 border-outline-variant pt-8 animate-fade-up stagger-5">
          <div className="md:w-1/4 mb-8 md:mb-0">
            <div className="text-6xl md:text-7xl font-headline font-black text-primary/20 leading-none">
              03
            </div>
          ...
          <div className="md:w-3/4 grid grid-cols-2 md:grid-cols-4 gap-4">
            {["PARTNER_01", "PARTNER_02", "PARTNER_03", "PARTNER_04", "PARTNER_05", "PARTNER_06"].map(
              (partner) => (
                <div
                  key={partner}
                  className="h-32 bg-surface-container-lowest border border-outline-variant flex items-center justify-center p-6 opacity-60 hover:opacity-100 transition-opacity"
                >
